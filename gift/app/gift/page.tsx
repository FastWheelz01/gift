...
export default function Page() {
  ...
  return (
    <main>
      <div className="relative min-h-screen bg-pink-500 flex flex-col items-center py-2">
        <h1 className="w-full px-30 font-bold text-white drop-shadow-lg text-2xl text-center">
